...
class PeptidesStructuralDataset(InMemoryDataset):
    ...
    def process(self):
        data_df = pd.read_csv(osp.join(self.raw_dir, 'peptide_structure_normalized_dataset.csv.gz'))
        ...
        for i in tqdm(range(len(smiles_list))):
            ...
            y = data_df.iloc[i][target_names].values.astype(np.float32)
    ...
    def get_idx_split(self):
        ...
        """
        split_file = osp.join(self.root, "splits_random_stratified_peptide_structure.pickle")
